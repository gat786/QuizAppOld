...
saveDataToDatabase(getDataFromUrl("17","hard","46","multiple"),"trivia_db","science_hard_multiple")
saveDataToDatabase(getDataFromUrl("22","hard","43","multiple"),"trivia_db","geography_hard_multiple")
saveDataToDatabase(getDataFromUrl("23","hard","50","multiple"),"trivia_db","history_hard_multiple")
saveDataToDatabase(getDataFromUrl("20","hard","8","multiple"),"trivia_db","mythology_hard_multiple")
saveDataToDatabase(getDataFromUrl("11","hard","29","multiple"),"trivia_db","films_hard_multiple")
saveDataToDatabase(getDataFromUrl("21","hard","9","multiple"),"trivia_db","sports_hard_multiple")
saveDataToDatabase(getDataFromUrl("18","hard","24","multiple"),"trivia_db","computers_hard_multiple")
